...
static const char *colors[][3]      = {
    ...
    [SchemeSel]   = { col_gray3, col_gray2, col_gray5 },
    [SchemeBar]   = { "#ff0000", "#00ff00", "#0000ff" },
};
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-l", "15", NULL }; // "-m", dmenumon, "-fn",  dmenufont, "-nb",  col_gray1, "-nf",  col_gray3, "-sb",  col_accen, "-sf",  col_gray4, NULL };
